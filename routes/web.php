...
Route::get('locale/{locale}','MainController@changeLocale')->name('locale');//смена языка
Route::get('currency/{currencyCode}','MainController@changeCurrency')->name('currency');//смена валюты
